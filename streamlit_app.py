...
def generate_slide_content(topic, content):
    ...
    response = openai.chat.completions.create(
        ...
        messages=[
            {"role": "system", "content": "You are a helpful assistant. Use the data from CSV to summarize Billable, RPN & Growth metrics for current and previous years for a Franchise."},
